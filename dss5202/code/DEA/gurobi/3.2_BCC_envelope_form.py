# -*- coding: utf-8 -*-
# 3.2_BCC_envelope_form.py
import gurobipy as gp
from gurobipy import GRB
from math import isclose
"""  BCC Model in Envelope Form 2024 10 20 """
...
def one_input_one_output():
    ...
    BCC_envelope(DMU, Inputs, Outputs, Inputs_data, Outputs_data)
...
def BCC_envelope(DMU, Inputs, Outputs, Inputs_data, Outputs_data):
    ...
    for r in DMU:
        ...
        c3=m.addConstr(gp.quicksum(lamda[k] for k in DMU) == 1, name='c3')
